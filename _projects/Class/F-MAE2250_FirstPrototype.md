...
### Proposed Direction SLF Automated Scent Trap
...
### Key Risks / Unknowns
1. Potential ecological impact on non-target species: Our device’s mechanisms might attract and harm pollinators and beneficial predators, affecting the vineyards’ ecosystem. To derisk: we can use a scent that minimizes the harm done to pollinators and conduct small-scale field tests.
2. Maintenance and Usability: Devices require routine maintenance (clear dead insects, refill chemicals, supply power) across many acres of land, thus needing additional labor to operate. To derisk, a bigger capacity can be used to reduce the required maintenance times.
...
<img src="{{ '/assets/images/inspo_fly_trap.png' | relative_url }}"
     style="display: block; width: 50%; margin: 0rem auto;">
